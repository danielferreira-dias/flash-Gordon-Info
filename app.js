...
function createHeadingSection() {
    ...
    // Set text content
    headingSectionTitle.textContent = "Flash Gordon";
        ...
        .then((data) => {
            ...
            data.Info.Section.forEach((section) => {
                ...
                section.SubSection.forEach((subSection) => {
                    ...
                    // Features Section
                    createNewSections(section, subSection, subContainer, container);
...
// create new sections
function createNewSections(mainSection, subSection, subContainer, mainContainer) {
